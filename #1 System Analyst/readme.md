# просьба
Перед прочтением данного документа переключить тему оформления браузера/Github на светлую.

*Никто ведь не печатает диаграммы на чёрной бумаге?* 
...
*и кстати, на скриншоте приложения нет ни пагинации, ни уточнения что данные должны прогружаться при свайпах вниз, так что это не ошибка что оба эти варианта не проработаны в API*
